...
const toggleSelection = async (item: Machine) => {
...
const handleSearchFactory = (items: Factory[]) => {
  selectedFactoryIDs.value = items.map((item) => item.id);
...
<template>
            ...
            <div>
              ...
              <div class="grid grid-cols-[min-content,1fr,min-content] gap-4 font-bold mb-2">
                ...
                <div class="grid grid-cols-5">
                  <span>工廠</span>
                  <span class="col-span-2">主設備類型</span>
                  <span class="col-span-2">主設備名稱</span>
                </div>
              ...
              <div class="space-y-2">
                ...
                >
                  ...
                  <div class="grid grid-cols-5" @click="toggleSelection(item)">
                    ...
                    <span class="col-span-2">{{ item?.machineType?.name || '-' }}</span>
                    <span class="col-span-2 truncate"
                      >{{ item.name }}
                      <!-- _{{ item.factoryScopedID }} -->
                    </span>
                  </div>
                  <button
                    class="text-sm w-[50px] rounded bg-primary text-center text-white px-2 py-1"
  ...
  />
  <FactoryCheckbox
    v-if="modalSearchFactoryOpen || selectedFactoryIDs"
