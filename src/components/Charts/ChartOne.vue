    ...
    <div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
      <div class="flex w-full flex-wrap gap-3 sm:gap-5">
        <div class="flex min-w-47.5">
          ...
          <div class="w-full">
            <p class="font-semibold text-primary">主設備實際運轉時間</p>
            <p class="text-sm font-medium">10.04.2024 - 10.05.2024</p>
          </div>
        </div>
        <div class="flex min-w-47.5">
          <span
          ...
          >
            <span class="block h-2.5 w-full max-w-2.5 rounded-full bg-[#8fca91]"></span>
          </span>
          <div class="w-full">
            <p class="font-semibold text-[#8fca91]">主設備預期運轉時數</p>
            <p class="text-sm font-medium">10.04.2024 - 10.05.2024</p>
          </div>
        </div>
      </div>
